      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="slides-3 swiper" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url({{asset('frontend')}}/assets/img/events-1.jpg)">
            ...
            <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url({{asset('frontend')}}/assets/img/events-2.jpg)">
            ...
            <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url({{asset('frontend')}}/assets/img/events-3.jpg)">
